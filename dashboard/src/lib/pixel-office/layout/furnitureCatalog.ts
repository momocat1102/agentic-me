...
export const FURNITURE_CATALOG: CatalogEntryWithCategory[] = [
  ...
  // ── Tileset — Desks ──
  { type: FurnitureType.TABLE_WOOD_SM_HORIZONTAL, label: 'Wood Table', footprintW: 2, footprintH: 1, sprite: TS_TABLE_WOOD_SM_HORIZONTAL, isDesk: true, category: 'desks' },
  ...
  { type: FurnitureType.DECO_3,            label: 'Deco',              footprintW: 2, footprintH: 2, sprite: TS_DECO_3,            isDesk: false, category: 'decor' },
  { type: FurnitureType.CLOCK,             label: 'Clock',             footprintW: 1, footprintH: 1, sprite: TS_CLOCK,             isDesk: false, category: 'decor' },
  { type: FurnitureType.LIBRARY_GRAY_FULL, label: 'Library',           footprintW: 2, footprintH: 2, sprite: TS_LIBRARY_GRAY_FULL, isDesk: false, category: 'storage' },
  ...
  { type: FurnitureType.PAINTING_LARGE_1,  label: 'Painting',          footprintW: 2, footprintH: 1, sprite: TS_PAINTING_LARGE_1,  isDesk: false, category: 'decor' },

  // ── Neko Cafe — Furniture ──
  { type: FurnitureType.COUNTER,             label: 'Counter',           footprintW: 2, footprintH: 2, sprite: [], isDesk: false, category: 'decor',   spriteSource: 'tileset', tilesetRect: { sx: 16, sy: 16, sw: 32, sh: 32 } },
  { type: FurnitureType.OVEN,                label: 'Oven',              footprintW: 2, footprintH: 2, sprite: [], isDesk: false, category: 'decor',   spriteSource: 'tileset', tilesetRect: { sx: 80, sy: 16, sw: 32, sh: 32 } },
  { type: FurnitureType.STOVETOP,            label: 'Stovetop',          footprintW: 2, footprintH: 2, sprite: [], isDesk: false, category: 'decor',   spriteSource: 'tileset', tilesetRect: { sx: 48, sy: 16, sw: 32, sh: 32 } },
  { type: FurnitureType.CABINET_WOOD,        label: 'Wood Cabinet',      footprintW: 2, footprintH: 2, sprite: [], isDesk: false, category: 'storage', spriteSource: 'tileset', tilesetRect: { sx: 144, sy: 16, sw: 32, sh: 32 } },
  { type: FurnitureType.SOFA_L_RIGHT,        label: 'L-Sofa',            footprintW: 4, footprintH: 2, sprite: [], isDesk: false, category: 'chairs',  spriteSource: 'tileset', tilesetRect: { sx: 80, sy: 112, sw: 64, sh: 32 } },
  { type: FurnitureType.FISH_TANK,           label: 'Fish Tank',         footprintW: 2, footprintH: 2, sprite: [], isDesk: false, category: 'decor',   spriteSource: 'tileset', tilesetRect: { sx: 16, sy: 64, sw: 32, sh: 32 } },
  { type: FurnitureType.POTTED_PLANT_CAFE,   label: 'Potted Plant',      footprintW: 1, footprintH: 2, sprite: [], isDesk: false, category: 'decor',   spriteSource: 'tileset', tilesetRect: { sx: 80, sy: 64, sw: 16, sh: 32 } },
  { type: FurnitureType.WALL_ART,            label: 'Wall Art',          footprintW: 2, footprintH: 2, sprite: [], isDesk: false, category: 'wall',    spriteSource: 'tileset', tilesetRect: { sx: 112, sy: 16, sw: 32, sh: 32 }, canPlaceOnWalls: true },
]
